    ...
    if(tmp_line!=NULL)
        {
            ...
            while(token!=NULL)  
              {  
                    ...
                    if(m==1)
                    {
                        item->cursection[0].protectvalue= atoi(token);
                    ...
                    {
                        item->cursection[1].protectvalue= atoi(token);
                    ...
                    {
                        item->cursection[2].protectvalue= atoi(token);
    ...
    if(tmp_line!=NULL)
        {
            ...
            while(token!=NULL)  
                {  
                    ...
                    if(t==1)
                    {
                        item->zerosection[0].protectvalue= atoi(token);
                    ...
                    {
                        item->zerosection[1].protectvalue= atoi(token);
                    ...
                    {
                        item->zerosection[2].protectvalue= atoi(token);
